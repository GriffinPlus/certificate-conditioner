...
func parseArgs() arguments {
	...
	flaggy.ResetParser()
	flaggy.SetName("Griffin+ Certificate Wizard v" + version)
	...
	flaggy.DefaultParser.AdditionalHelpPrepend = "A tool easing common tasks concerning the handling of X.509 certificates."

	// add additional text shown after the flags help
	flaggy.DefaultParser.AdditionalHelpAppend = "\n" +
		"------------------------------------------------------------------------------------------------------------------------\n" +
		"Project:      https://github.com/griffinplus/certificate-wizard\n" +
	...
	// add subcommands
	subcommands := []command{NewConditionCommand()}
